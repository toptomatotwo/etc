...
<?php
		...
		function createContent() {
			...
			if( get_option('easy_privacy_acknowlegement') == true ) {
				$content = $content.'<span style="font-size:11px;">This policy was generated by Easy Privacy Policy Plugin <a target="_blank" href="http://thepacificboxset.feedr.co.uk">The Pacific Box Set</a> for WordPress.</span>';
			}
