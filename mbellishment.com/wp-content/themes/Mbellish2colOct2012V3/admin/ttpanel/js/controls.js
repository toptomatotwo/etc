...
jQuery('.btn_reset').click(function(){
  //  alert('dick');
    jQuery('#ttpanel_form').attr('action', '?page=functions.php&action=ttpanel_reset');
});
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////    
    ...
    jQuery(".btn_switch").click(function() {
      ...
      if(new_value == 1)
      {
        jQuery(this).find(".btn_switch_input").attr("value", 0);
        jQuery(this).find(".on_off").stop().animate({left: -51}, switch_speed);  
      }
      else
      {
        jQuery(this).find(".btn_switch_input").attr("value", 1);
        jQuery(this).find(".on_off").stop().animate({left: -2}, switch_speed);  
      }
    });
...
//      var wp_content_height = jQuery(".wrapper_bg").css("height");
//      jQuery("#ttpanel").css("height", wp_content_height);
//    });
//////////////////////////////////////////////////////////////////////////////
// SELECTBOX function
//////////////////////////////////////////////////////////////////////////////    
...
/*      jQuery("body").mousemove(function(e){
    ...
    /*jQuery.get("http://freshface.cz/ttpanel/mythemes.php", function(data, text){
