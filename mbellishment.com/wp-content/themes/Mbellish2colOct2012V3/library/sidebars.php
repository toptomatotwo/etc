<?php
  ...
  $theme_sidebars = array(
   ...
   'default' => array(
    ...
    'special' =>  array(
      'name' => __('Special Widget Area',THEME_NS),
      'id' => 'special-widget-area',
      'description' => __("This sidebar is active only when used with the variable option.", THEME_NS)
    ),
    
    'header' =>  array(
      'name' => __('Header Widget Area',THEME_NS),
      'id' => 'header-widget-area',
      'description' => __("This widget area is active only when used with the header modifications in the Advanced Options section.", THEME_NS)
    ),
    ...
    'bottom3' => array(
      'name' => __('Third Bottom Widget Area',THEME_NS),
      'id' => 'third-bottom-widget-area',
      'description' => __("This sidebar is displayed below the main content.", THEME_NS)
    ),
    
    'bottom4' => array(
      'name' => __('Fourth Bottom Widget Area',THEME_NS),
      'id' => 'fourth-bottom-widget-area',
      'description' => __("This sidebar is displayed below the main content.", THEME_NS)
    ),
