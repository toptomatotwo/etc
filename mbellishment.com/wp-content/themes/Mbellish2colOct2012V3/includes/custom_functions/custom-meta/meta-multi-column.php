<div class="my_meta_control">
	<div id="accordion-container">
		<div class="accordion-header"><?php _e('Multi Column Page Example Layout', THEME_NS); ?> </div>		
		...
		<div class="customEditor"><textarea name="<?php $mb->the_name(); ?>"><?php echo esc_html(wp_richedit_pre($mb->get_the_value())); ?></textarea></div>
		</p>
		</div>
