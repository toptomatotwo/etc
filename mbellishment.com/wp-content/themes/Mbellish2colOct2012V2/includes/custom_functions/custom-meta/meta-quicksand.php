<div class="my_meta_control">
	<div id="accordion-container">
		<div class="accordion-header"><?php _e('Quicksand Filterable Notes', THEME_NS); ?> </div>		
		<div class="accordion-content"> 		
		<p>	
		<?php _e('This page template uses the jQuery Quicksand script to filter posts by category using a smooth animation effect.', THEME_NS); ?>
