<div class="my_meta_control">
	<div id="accordion-container">
		<div class="accordion-header"><?php _e('Magazine #1 Example Layout', THEME_NS); ?> </div>		
		<div class="accordion-content"> 		
		<p>		
		<img style="margin:0 0 0 25px;" src="<?php bloginfo('template_url'); ?>/includes/custom_functions/images/mag1-small.png" />
		</p>
		</div>
        <!-- widgetized meta  -->
		...
		<div class="accordion-header"><?php _e('Post Content Area', THEME_NS); ?> </div>
		<div class="accordion-content"> 
		<p>
		<strong><?php _e('Content block header and content appearance', THEME_NS); ?></strong>
		</p>
		<p class="required">
		...
		<div class="hr-meta"></div>
		<p>
		<strong><?php _e('Image Size, Position and Shadow', THEME_NS); ?></strong>	
		</p>
		<p>
...
<div class="hr-meta"></div>		
		<p>
		<strong><?php _e('Adjust paragraph padding', THEME_NS); ?> </strong>
		</p>
		<p>		
