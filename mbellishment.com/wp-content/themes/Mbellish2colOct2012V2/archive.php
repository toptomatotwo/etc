...
<?php if (theme_get_option('top_sidebar_archive') && theme_get_option('top_sidebar_wide_archive')) {get_sidebar('top');} ?>
<?php tt_get_header_layout(); ?>
			...
			?>
			<?php if (theme_get_option('bot_sidebar_archive') && !theme_get_option('bot_sidebar_wide_archive')) {get_sidebar('bottom');} ?>
