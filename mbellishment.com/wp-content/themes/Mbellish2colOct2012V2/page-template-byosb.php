...
global $custom_metabox_byosb;
$meta_test1 = $custom_metabox_sidebar_content->the_meta();
...
while($custom_metabox_sidebar_content->have_fields('docs'))
{

    $new_sidebar_name = $custom_metabox_sidebar_content->get_the_value('custom_sidebar_title');

    $new_sidebar_name = $custom_metabox_sidebar_content->get_the_value('custom_sidebar_title');
    $custom_sidebar_style = $custom_metabox_sidebar_content->get_the_value('custom_sidebar_style');
    echo '<div class="'.$new_sidebar_name.'-sidebar">';
        theme_dynamic_sidebar($new_sidebar_name) ;
    echo '</div><!-- end '.$new_sidebar_name.'-sidebar -->';
