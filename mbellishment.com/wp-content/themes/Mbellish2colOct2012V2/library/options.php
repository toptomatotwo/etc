...
$theme_nav_items = tt_nav_menu_items();
global $theme_options;
$theme_options = array (
	array(	
	...
	'name'	=>	__('Disable parent menu link in horizontal menu', THEME_NS),
	...
	'name'	=>	__('Disable parent menu link in WP nav menu', THEME_NS),
	'desc'	=>	__('Check to disable the menu parent item in menus that use the wp_nav_menu (custom menu not vertical menu). If the menu item has a sub-menu the parent item will become un-linked. This would apply to the site map page templates that use the WP custom menu for page listings. ', THEME_NS),
	'type'	=>	'checkbox'
	),
	...
	array(	
	'id'	=>	'theme_sidebars_style_special',
	'name'	=>	__('Special sidebar', THEME_NS),
	'type'	=>	'select',
	'desc'	=>	'This widget area is only available when using the sidebar modifications in post/page edit',
	'options'	=>	$theme_sidebars_style_options
	),
	array(	
	...
	'type'	=>	'select',
	'desc'	=>	'This widget area is only available when using the special header modifications in Advanced Options',
	'options'	=>	$theme_sidebars_style_options
	),
	array(	
	'id'	=>	'theme_sidebars_style_homeleft',
	'name'	=>	__('Home Page left widget area', THEME_NS),
	'type'	=>	'select',
	'desc'	=>	'This widget area is only available when using the Home Page templates',
	'options'	=>	$theme_sidebars_style_options
	),
	array(	
	'id'	=>	'theme_sidebars_style_homeright',
	'name'	=>	__('Home Page right widget area', THEME_NS),
	'type'	=>	'select',
	'desc'	=>	'This widget area is only available when using the Home Page templates',
	'options'	=>	$theme_sidebars_style_options
	),
...
$theme_page_meta_options = array (
	...
	array(	
	'id'	=>	'theme_show_sb_top',
	'name'	=>	__('Show Top Widgets', THEME_NS),
	'desc'	=>	__('Yes. Show top widget area.', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_top_wide',
	'name'	=>	__('Place Top Widgets Above Sidebars', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_bot',
	'name'	=>	__('Show Bottom Widgets', THEME_NS),
	'desc'	=>	__('Yes. Show bottom widget area.', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_bot_wide',
	'name'	=>	__('Place Bottom Widgets Above Footer', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),
	
	array(	'id'	=>	'theme_show_page_title',
	'name'	=>	__('Show Title on Page', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),
	
	array(	'id'	=>	'theme_nav_menu_choose',
	'name'	=>	__('Use A Custom Menu For This Page', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),	
	array(	'id'	=>	'theme_nav_menu_items',
	'name'	=>	'none',
	'type'	=>	'select',
	'sub' => 'Choose an existing custom menu',
	'options'	=>	$theme_nav_items
	)
);
...
$theme_post_meta_options = array(
	array(	
	'id'	=>	'theme_show_author_box',
	'name'	=>	__('Show Author Box', THEME_NS),
	'desc'	=>	__('Shows the authors avatar, nickname and bio info below the post.', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_author_box_style',
	'name'	=>	__('Author Box Style', THEME_NS),
	'type'	=>	'select',
	'desc'	=>	'This determines the style of the Author Box.',
	'options'	=>	$theme_sidebars_style_options
	),
	...
	'id'	=>	'theme_show_sb_top',
	'name'	=>	__('Show Top Widgets', THEME_NS),
	'desc'	=>	__('Yes. Show First/Second top widgets.', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_top_wide',
	'name'	=>	__('Place Top Widgets Below Header', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_bot',
	'name'	=>	__('Show Bottom Widgets', THEME_NS),
	'desc'	=>	__('Yes. Show First/Second bottom widgets.', THEME_NS),
	'type'	=>	'checkbox'
	),
	array(	
	'id'	=>	'theme_show_sb_bot_wide',
	...
	array(		'id'	=>	'theme_show_post_title',
	...
	array(	'id'	=>	'theme_nav_menu_choose',
	'name'	=>	__('Use A Custom Menu For This Post', THEME_NS),
	'desc'	=>	__('Yes', THEME_NS),
	'type'	=>	'checkbox'
	),	
	array(	'id'	=>	'theme_nav_menu_items',
