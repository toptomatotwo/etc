...
function theme_basic_wrapper($args = '') {
	$args = wp_parse_args($args, 
		array(
			'id' => '',
			'class' => '',
	...
	echo "<div class=\"art-post basic\">";
	echo "<div class=\"art-post-body basic\">";
	echo '<div class="art-postcontent"><h3 style="margin:0;">' . $title . '</h3></div>';
